...
public:
    EnergyGradientTargetFunction(WaveFunction * wf, Hamiltonian * H, int E_Nmc, int grad_E_Nmc, mci::MCI * mci, bool useGradErr, double lambda_reg = 0.):
            nfm::NoisyFunctionWithGradient(wf->getNVP(), useGradErr),
