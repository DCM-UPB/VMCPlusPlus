...
int main()
{
    ...
    const int E_NMC = 50000l; // MC samplings to use for computing the energy during optimization
    const int G_NMC = 500000l; // MC samplings to use for computing the energy gradient
